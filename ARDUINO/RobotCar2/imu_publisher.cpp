...
{
    imu_msg_.header.frame_id = micro_ros_string_utilities_set(imu_msg_.header.frame_id, "robot2/imu_link");
...
const void ImuPublisher::euler_to_quat(float roll, float pitch, float yaw, float* q)
{
